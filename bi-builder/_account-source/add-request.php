...
<section class="contact section-padding pt-0">
    <div class="container">
        <div class="form">
            <form id="add-request" action="admin-ajax" method="post">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="checkbox-wrap">
                                <div class="item">
                                    <input type="radio" name="status" id="waiting" value="1" checked>
                                    <label for="waiting">Mở ngay</label>
                                </div>
                                <div class="item">
                                    <input type="radio" name="status" id="closed" value="0">
                                    <label for="closed">Chưa mở</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <div class="checkbox-wrap">
                                <div class="item">
                                    <input type="radio" name="type" id="offline" value="0" checked>
