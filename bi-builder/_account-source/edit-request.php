...
<section class="contact section-padding pt-0">
    <div class="container">
        <div class="form">
            <input type="hidden" class="back-page" value="<?= Config::HOME_PATH ?>/tai-khoan?de-nghi-day&lop-hoc&data=<?= $data->getID() ?>">
            <form id="edit-user-room" action="admin-ajax" method="post">
                ...
                <div class="form-box bg-repeat bg-img" data-background="img/bg-pattern.jpg" data-title="Lớp học">
                    <div class="form-group">
                        ...
                        <a href="<?= Config::HOME_PATH ?>/lop-hoc?data=<?= $data->getID() ?>"><?= Config::HOME_PATH ?>/lop-hoc?data=<?= $data->getID() ?></a>
                    </div>
                    <div class="form-group">
                        <label>Tên</label>
                            ...
                            <?php if ($isEdit) : ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input class="form-control border-dark<?= $isEdit ? '' : ' view'; ?>" name="wards" value="<?= isset($address[1]) ? $address[1] : '' ?>"/>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label>Tên Đường/ Số nhà</label>
                                        <input class="form-control border-dark<?= $isEdit ? '' : ' view'; ?>" name="street" value="<?= isset($address[0]) ? $address[0] : '' ?>"/>
                                    </div>
                                </div>
                            <?php else: ?>
                ...
                <div class="btn-wrap text-center mt-50">
                    ...
                    <?php else: ?>
                        <a href="?de-nghi-day&data=<?= $data->getID() ?>&edit=true" class="btn-curve btn-blc"><span>Chỉnh sửa</span></a>
                        <a href="?de-nghi-day&data=<?= $data->getID() ?>&view=true" class="btn-curve btn-blc"><span>Xem gia sư ứng tuyển</span></a>
                        <a href="?de-nghi-day&data=<?= $data->getID() ?>&edit=true" class="btn-curve btn-color"><span>Xóa</span></a>
                    <?php endif; ?>
                </div>
            </form>
        </div>
