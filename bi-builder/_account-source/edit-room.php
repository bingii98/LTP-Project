        ...
        <div class="form">
            ...
            <form id="edit-user-room" action="admin-ajax" method="post">
                ...
                <div class="btn-wrap text-center mt-50">
                    ...
                    <?php else: ?>
                        <a href="?lop-hoc&data=<?= $data->getID() ?>&edit=true" class="btn-curve btn-blc"><span>Chỉnh sửa</span></a>
                        <a href="?lop-hoc&data=<?= $data->getID() ?>&edit=true" class="btn-curve btn-color"><span>Xóa</span></a>
                    <?php endif; ?>
                </div>
            </form>
        </div>
