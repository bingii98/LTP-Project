...
$users = User::get_user_pagination_teacher_filter($page, $_GET);
                        ...
                        <?php foreach ($users['data'] as $user) : ?>
                            <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                                <div class="item profile-item wow fadeInUp md-mb50" data-wow-delay=".3s">
                                    <a class="d-block" href="<?= Config::HOME_PATH ?>/chi-tiet-gia-su?id=<?= $user->getUserID() ?>">
                                        <div class="avatar">
                                            ...
                                            <?php endif; ?>
                                            <?= User::get_user_rating_display($user->getUserID()); ?>
                                        </div>
                                        <div class="caption">
